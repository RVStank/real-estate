...
public class FloorServiceTest {
    ...
    public void verifyFindAll() {
        ...
        Set<Floor> all = floorServiceImpl.findAll();
    }

    @Test
    public void verifySave() {
        Floor floorSave = Floor.builder().build();
        when(floorRepository.save(any())).thenReturn(floorSave);
    ...
    public void verifySaveDuplicateException() {
        when(floorRepository.save(any())).thenReturn(DataIntegrityViolationException.class);
